...
class PropertyPage extends React.Component {
    ...
    render() {
        ...
        const {currentProperty, cities, states, openModal, currentUser} = this.props;
        ...
        return (
            <div className='property-page'>
                ...
                <PropertyDetails currentUser={currentUser} openModal= {openModal} currentProperty={currentProperty}/>
